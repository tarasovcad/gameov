  ...
  return (
    <Popover open={popoverVisible} onOpenChange={setPopoverVisible}>
      <PopoverTrigger asChild>
        <motion.button
          whileTap={{scale: 0.96}}
          className="flex items-center gap-2.5 rounded-md bg-bg py-[6px] px-5 border border-border hover:bg-border/50 transition-colors duration-300 ease-in-out max-[730px]:px-[12px] ">
          <ArrowDownUp size={18} />{" "}
