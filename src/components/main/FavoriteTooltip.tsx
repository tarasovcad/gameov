...
//               <motion.div
//                 className={`p-[6px]  rounded-full flex items-center justify-center ${reverseStyle ? "bg-bg dark:bg-white text-white dark:text-black " : "dark:bg-bg bg-white"}`}>
  ...
  return (
    <div className="absolute top-[9px] right-[9px] opacity-0 group-hover:opacity-100 transition-opacity duration-200">
      <button
        ...
        onMouseLeave={handleMouseLeave}>
        <motion.div
          className={`p-[6px]  rounded-full flex items-center justify-center ${reverseStyle ? "bg-bg dark:bg-white text-white dark:text-black " : "dark:bg-bg bg-white"} ${color ? color : ""}`}>
          <AnimatePresence mode="wait">
            {!isFavorite ? (
              <motion.div
                key="plus"
