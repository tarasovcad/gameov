  ...
  return (
    <Link href={""}>
      <div className="mainitem relative min-h-[210px] text-white rounded-xl flex overflow-hidden ">
        ...
        />
        <div
          className={`${"relative p-5 flex flex-col gap-1 justify-end"} ${montserrat.className}`}>
          <h2 className="font-bold text-xl tracking-[0.02em]">
            Chaperone (2023)
          </h2>
          <p className="font-normal text-sm text-[#e9e9e9] tracking-[0.01em] leading-6">
